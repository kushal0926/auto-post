        ...
        <div className="relative rounded overflow-hidden p-14 sm:p-20 text-center border border-black/10 hover:bg-black/1">
          <div className="relative">
            ...
            <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-3">
              <Link
                to="/login"
                className="bg-charcol text-cream border-[1.5px] border-black/10 rounded font-medium hover:bg-black/5 hover:border-black/20 hover:text-charcol inline-flex items-center gap-2 text-[15px] px-10 py-4 w-full sm:w-auto justify-center transition-all"
              >
                Get Started Free <ArrowRightIcon className="size-4" />
              </Link>
              <a
                href="#pricing"
                className="bg-transparent text-charcol border-[1.5px] border-black/10 rounded font-medium hover:bg-black/5 hover:border-black/20 inline-flex items-center gap-2 text-[15px] px-10 py-4 w-full sm:w-auto justify-center"
              >
                View Pricing
              </a>
            </div>
